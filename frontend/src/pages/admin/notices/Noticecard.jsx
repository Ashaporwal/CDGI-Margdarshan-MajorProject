...
import { FiEdit2, FiTrash2, FiCalendar, FiLink, FiClock, FiChevronDown, FiChevronUp } from "react-icons/fi";
...
const DESC_LIMIT = 100; // characters shown before "Read More"
...
function isExpired(deadline) {
 ...
 function NoticeCard({ notice, onEdit, onDelete }) {
  ...
  const isLong        = notice.description.length > DESC_LIMIT;
  const displayedDesc = expanded
    ? notice.description
    : notice.description.slice(0, DESC_LIMIT) + (isLong ? "..." : "");
  ...
  return (
    ...
    >
      ...
      <div className="text-sm text-gray-500 leading-relaxed">
        ...
        {/* Show Read More / Read Less only if description is long */}
        {isLong && (
          <button
      ...
      {/* ── Footer: Posted Date + Deadline + Link ── */}
