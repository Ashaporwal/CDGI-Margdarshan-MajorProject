...
//       text-gray-500 dark:text-gray-400 px-2.5 py-1 rounded-full font-semibold">
//         Ended
//       </span>
//     );
//   if (diffDays === 0)
...
//       text-red-600 dark:text-red-400 px-2.5 py-1 rounded-full font-semibold animate-pulse">
//         🔴 Last Day!
//       </span>
//     );
//   if (diffDays <= 3)
...
//       text-orange-500 dark:text-orange-400 px-2.5 py-1 rounded-full font-semibold">
...
// // ── Random gradient per event title ──────────────────────
// const GRADIENTS = [
...
//   const hasLongDesc = event.description?.length > 180;
...
//       {/* Poster or gradient banner */}
//       {event.posterImage ? (
//         <div className="w-full h-52 overflow-hidden bg-gray-100 dark:bg-gray-700 flex-shrink-0">
//           <img
...
//         leading-relaxed mb-3 whitespace-pre-line flex-1">
...
//         {event.deadline && (
//           <div className="flex items-center gap-1.5 text-xs
//           bg-gray-50 dark:bg-gray-700/50 rounded-xl px-3 py-2 mb-4
//           text-gray-400 dark:text-gray-500">
//             <FiClock size={11} />
//             <span>
//               Registration closes:{" "}
...
//             py-2.5 rounded-xl text-sm font-semibold transition mt-auto
//             ${isEnded
//               ? "bg-gray-100 dark:bg-gray-700 text-gray-400 cursor-not-allowed pointer-events-none"
//               : `bg-gradient-to-r ${gradient} text-white hover:opacity-90 shadow-md`
//             }`}
//           >
...
// // ── Hero Banner ──────────────────────────────────────────
// function HeroBanner({ total, activeCount }) {
//   return (
//     <div className="relative bg-gradient-to-br from-violet-600 via-purple-600
//     to-indigo-600 rounded-2xl p-8 overflow-hidden text-white">
...
//       <div className="absolute bottom-0 left-10 w-40 h-40 bg-white/5
//       rounded-full translate-y-1/2 pointer-events-none" />

//       <div className="relative z-10">
//         <p className="text-violet-200 text-sm font-medium mb-1 uppercase tracking-wider">
//           CDGI Margdarshan
//         </p>
//         <h1 className="text-3xl font-bold mb-2">🎉 College Events</h1>
//         <p className="text-violet-200 text-sm mb-6 max-w-md">
...
//             <p className="text-xs text-violet-200">Total Events</p>
//           </div>
//           <div className="bg-white/15 backdrop-blur-sm rounded-xl px-5 py-3">
//             <p className="text-2xl font-bold">{activeCount}</p>
//             <p className="text-xs text-violet-200">Active Now</p>
//           </div>
//         </div>
//       </div>
//     </div>
